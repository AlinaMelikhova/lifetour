...
var _youtube = require("./modules/youtube");
var _swipers = require("./modules/swipers");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  (0, _mobileMenu.handleMobileMenu)();
  (0, _youtube.playVideo)();
...
},{"./modules/form-validate/form":3,"./modules/leaflet":9,"./modules/mobile-menu":10,"./modules/swipers":11,"./modules/youtube":12,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
var mainPinIcon = window.L.icon({
  iconUrl: './img/svg/map-pin.svg',
  iconSize: [48, 48],
  iconAnchor: [19, 50]
});
var mainPinMarker = window.L.marker({
  lat: 55.774778,
  lng: 37.632483
}, {
  icon: mainPinIcon
...
exports.handleMobileMenu = void 0;
var menuToggleButton = document.querySelector('.header__mob-menu-button');
var menuOpenIcon = document.querySelector('.header__mob-menu-icon-burger');
var menuCloseIcon = document.querySelector('.header__mob-menu-icon-cross');
var menuWrapper = document.querySelector('.header__positioning-wrapper');
var pageWrapper = document.querySelector('.page-wrapper');
var heroWrapper = document.querySelector('.hero__container');
var menuLinks = Array.from(document.querySelectorAll('.header__menu-item'));
var toggleMenuStyles = function toggleMenuStyles() {
...
var menuLinksHandler = function menuLinksHandler() {
  hideMenu();
  return;
};
...
exports.handleMobileMenu = handleMobileMenu;
...
var initHeroSwiper = function initHeroSwiper() {
  ...
  new _swiper.default('.swiper-hero', {
...
var initToursSwiper = function initToursSwiper() {
  // eslint-disable-next-line no-new
  new _swiper.default('.swiper-tours', {
    direction: 'horizontal',
    loop: false,
    slidesPerView: 1,
    spaceBetween: 0,
...
var initEducationSwiper = function initEducationSwiper() {
  // eslint-disable-next-line no-new
  new _swiper.default('.swiper-education', {
    direction: 'horizontal',
    loop: false,
    slidesPerView: 1,
    spaceBetween: 15,
...
var initReviewSwiper = function initReviewSwiper() {
  // eslint-disable-next-line no-new
  new _swiper.default('.swiper-review', {
    direction: 'horizontal',
    loop: false,
    slidesPerView: 'auto',
    spaceBetween: 15,
...
var initBenefitsSwiper = function initBenefitsSwiper() {
  // eslint-disable-next-line no-new
  new _swiper.default('.swiper-benefits', {
    direction: 'horizontal',
    loop: true,
    centeredSlides: true,
    slidesPerView: 'auto',
...
var initGalleruSwiper = function initGalleruSwiper() {
  // eslint-disable-next-line no-new
  new _swiper.default('.swiper-gallery', {
    direction: 'horizontal',
    loop: false,
    slidesPerView: 'auto',
    spaceBetween: 5,
...
var initSwipers = function initSwipers() {
  ...
  if (window.matchMedia('(min-width:1200px)').matches) {
    ...
    Array.from(document.querySelectorAll('.benefits__item')).forEach(function (slide) {
...
},{"../vendor/swiper.js":15}],12:[function(require,module,exports){
"use strict";
...
var videoContainer = document.querySelector('.hero__video-container');
var videoPoster = document.querySelector('.hero__video-cover');
var videoButton = document.querySelector('.hero__video-cover-button');
var addYoutubeVideo = function addYoutubeVideo() {
  var youtubeFrame = document.createElement('iframe');
  youtubeFrame.src = 'https://www.youtube.com/embed/9TZXsZItgdw?autoplay=1&rel=0';
